                ...
                if (updateUser.length > 0) {
                    ...
                    if (trasaction) {
                        ...
                        return generalResponse(
                            res,
                            {},
                            `Transaction Successfull ${newly_added_coins.coins} added in your Aegis Live Account`,
                            true,
                            true
                        );
                    }
                    ...
                    if (updated_reciver.length > 0) {
                        ...
                        if (transaction) {
                            ...
                            return generalResponse(
                                res,
                                {},
                                `Transaction Successfull ${filteredData.coin} deducted from your Aegis Live Account`,
                                true,
                                true
                            );
                        }
